...
wsl.exe bash -lc "cd '%PROJECT_ROOT_WSL%' && export CODEX_THREAD_ID='%CODEX_THREAD_ID%' GEMINI_BATCH_TIMEOUT_BASE_SECONDS='%GEMINI_BATCH_TIMEOUT_BASE_SECONDS%' GEMINI_BATCH_TIMEOUT_PER_SEGMENT_SECONDS='%GEMINI_BATCH_TIMEOUT_PER_SEGMENT_SECONDS%'; python3 tools/gemini_ui_supervisor.py"
